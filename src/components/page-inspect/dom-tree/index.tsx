...
const getName = (data: DOMEntry) =>
  (data as DOMEntryJava).simpleType || data.type || "unknown";

const ATTRS: (keyof DOMEntryJava | keyof DOMEntryWeb)[] = [
  "name",
  "label",
  "tooltip",
  "_title",
  ...
  return (
    <span className={style.tag}>
      ...
      {Object.keys(attrs).map((key) => {
        return (
          <span key={key} className={style.attr}>
...
const DOMTree: TreeComponent<DOMEntry> = treeFactory(
  Opener,
  Closer,
  (data: DOMEntry) => {
